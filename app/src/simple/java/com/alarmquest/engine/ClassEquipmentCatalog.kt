...
internal object ClassEquipmentCatalog {
    ...
    private val archetypes: Map<HeroClass, Map<EquipmentSlot, List<String>>> = mapOf(
        ...
        HeroClass.RANGER to mapOf(
            EquipmentSlot.WEAPON to listOf("단궁", "장궁", "사냥활", "복합궁", "석궁", "레인져 창"),
            EquipmentSlot.HEAD to listOf("레인져 두건", "깃털 모자", "정찰 후드", "숲 머리띠", "추적 가면", "매사냥 모자"),
            EquipmentSlot.BODY to listOf("레인져 사냥복", "정찰 조끼", "가죽 갑옷", "숲 외투", "추적자 경갑", "매사냥 코트"),
