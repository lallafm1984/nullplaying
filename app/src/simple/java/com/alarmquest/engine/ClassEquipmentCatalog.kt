 ...
 * three hero levels. Existing saved item names remain valid because only newly generated names
 * read this catalog.
 */
internal object ClassEquipmentCatalog {
    ...
    private val archetypes: Map<HeroClass, Map<EquipmentSlot, List<String>>> = mapOf(
        HeroClass.WARRIOR to mapOf(
            ...
            EquipmentSlot.HEAD to listOf("전사 투구", "철면", "돌격 두건", "사슬모자", "뿔투구", "지휘관 투구"),
            EquipmentSlot.BODY to listOf("전사 갑옷", "판금 흉갑", "사슬갑옷", "돌격 외투", "중갑", "지휘관 갑주"),
            EquipmentSlot.HANDS to listOf("전사 건틀릿", "완갑", "전투 장갑", "손갑", "주먹갑", "지휘관 손목보호대"),
            EquipmentSlot.FEET to listOf("전사 장화", "중장화", "각반", "철제신", "돌격 전투화", "지휘관 판금화"),
            EquipmentSlot.ACCESSORY to listOf("힘의 반지", "전투 목걸이", "용맹 브로치", "투지 부적", "전사 허리띠", "승전 인장"),
        ),
        HeroClass.ROGUE to mapOf(
            EquipmentSlot.WEAPON to listOf("단검", "쌍단검", "암살검", "투척검", "곡도", "손쇠뇌"),
            EquipmentSlot.HEAD to listOf("도적 후드", "복면", "잠행 두건", "야행 머리띠", "암살 가면", "그림자 모자"),
            EquipmentSlot.BODY to listOf("도적 가죽옷", "잠행복", "암살 조끼", "그림자 외투", "경량 갑옷", "야행 코트"),
            EquipmentSlot.HANDS to listOf("도적 장갑", "손가락 장갑", "투척 장갑", "잠행 완갑", "암살 손목띠", "그림자 손갑"),
            EquipmentSlot.FEET to listOf("도적 장화", "잠행화", "경량 각반", "암살 장화", "그림자 신발", "야행 전투화"),
            EquipmentSlot.ACCESSORY to listOf("기민 반지", "독니 목걸이", "은신 브로치", "행운 부적", "도구 허리띠", "도적 인장"),
        ),
        HeroClass.RANGER to mapOf(
            EquipmentSlot.WEAPON to listOf("단궁", "장궁", "사냥활", "복합궁", "석궁", "순찰자 창"),
            EquipmentSlot.HEAD to listOf("순찰자 두건", "깃털 모자", "정찰 후드", "숲 머리띠", "추적 가면", "매사냥 모자"),
            EquipmentSlot.BODY to listOf("순찰자 사냥복", "정찰 조끼", "가죽 갑옷", "숲 외투", "추적자 경갑", "매사냥 코트"),
        ...
        HeroClass.MAGE to mapOf(
            ...
            EquipmentSlot.HEAD to listOf("마도사 관", "마법 모자", "현자 후드", "룬 머리띠", "별 가면", "주문 두건"),
            EquipmentSlot.BODY to listOf("마도사 로브", "비전 외투", "룬 예복", "원소 망토", "현자 의복", "별빛 법복"),
            EquipmentSlot.HANDS to listOf("마력 장갑", "주문 손목띠", "룬 완갑", "원소 장갑", "현자 손갑", "비전 소매"),
            EquipmentSlot.FEET to listOf("마도사 신발", "비단신", "룬 장화", "원소 각반", "현자 장화", "별빛 덧신"),
        ...
        HeroClass.CLERIC to mapOf(
            ...
            EquipmentSlot.HEAD to listOf("사제 두건", "성직 관", "기도 머리띠", "성가대 모자", "성유 가면", "신관 관"),
            EquipmentSlot.BODY to listOf("사제복", "성직자 로브", "기도 예복", "성가 외투", "신관 법복", "성유 망토"),
            EquipmentSlot.HANDS to listOf("기도 장갑", "성직 완갑", "성유 손목띠", "치유 장갑", "신관 손갑", "성가 소매"),
            EquipmentSlot.FEET to listOf("사제 신발", "성직 장화", "기도 각반", "순례화", "신관 비단신", "성유 장화"),
            EquipmentSlot.ACCESSORY to listOf("기도 반지", "성상 목걸이", "성가 브로치", "치유 부적", "성직 허리띠", "신앙 인장"),
        ),
        HeroClass.PALADIN to mapOf(
            EquipmentSlot.WEAPON to listOf("성검", "성전 철퇴", "심판 망치", "기도창", "수호 대검", "왕실 장검"),
            EquipmentSlot.HEAD to listOf("성기사 투구", "성전 면갑", "수호 관", "왕실 투구", "심판 가면", "서약 두건"),
            EquipmentSlot.BODY to listOf("성기사 갑옷", "성전 흉갑", "수호 판금", "왕실 갑주", "심판 외투", "서약 사슬갑옷"),
            EquipmentSlot.HANDS to listOf("성기사 건틀릿", "성전 완갑", "수호 손갑", "왕실 장갑", "심판 주먹갑", "서약 손목보호대"),
            EquipmentSlot.FEET to listOf("성기사 장화", "성전 각반", "수호 철제신", "왕실 전투화", "심판 장화", "서약 판금화"),
            EquipmentSlot.ACCESSORY to listOf("서약 반지", "성휘 목걸이", "성전 브로치", "수호 부적", "성기사 허리띠", "심판 인장"),
        ),
    )
