...
class SimpleGameEngine(
    ...
    fun offlineAdventureCapacityMillis(state: SimpleGameState): Long =
        offlineAdventureConfig.capacityMillis + StatBonusRules.adventureBonusMillis(state)
    ...
    companion object {
        ...
        const val OFFLINE_ADVENTURE_CAPACITY_MILLIS = 8L * 60L * 60L * 1_000L
        private const val LEGACY_OFFLINE_ADVENTURE_EARN_RATE = 60L
        private const val MAX_STORED_OFFLINE_ADVENTURE_MILLIS =
            OfflineAdventureConfig.MAX_CAPACITY_MINUTES * 60_000L + StatBonusRules.MAX_ADVENTURE_BONUS_MILLIS
