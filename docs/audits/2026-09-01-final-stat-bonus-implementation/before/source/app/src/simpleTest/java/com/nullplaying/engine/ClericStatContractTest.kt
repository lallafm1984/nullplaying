...
class ClericStatContractTest {
    ...
    @Test
    fun `cleric offense and proc use charisma rather than intelligence`() {
        ...
        assertEquals(13, engine.skillProcPercent(game))
        game.hero.stats.intelligence = 1000
        assertEquals(13, engine.skillProcPercent(game))
        game.hero.stats.charisma = 125
        assertEquals(18, engine.skillProcPercent(game))
    }
