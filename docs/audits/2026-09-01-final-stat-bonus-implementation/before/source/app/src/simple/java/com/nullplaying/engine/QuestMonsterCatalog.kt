...
internal data class QuestMonsterDefinition(
    ...
    val trophyNames: List<String>
        get() = listOf(
            ...
            "${baseName}의 조직 표본", "${baseName}의 둥지 부스러기", "${baseName}의 발자국 석고",
...
internal object QuestMonsterCatalog {
    ...
    val groups: List<QuestMonsterGroup> = StarterPrologueMonsterCatalog.groups + listOf(
        group(
            "ash_border.c01",
            "재먼지 들쥐|막사 뒷거미|잔불 박쥐|검댕 뿔토끼|성벽 여우|잿빛 갈까마귀|부러진 창 도마뱀|등불 나방|숨은 하이에나|재밭 딱정벌레",
            "순찰대 포식자|발자국 지우개",
        ...
        group(
            ...
            "우물밑 잠복자|새벽종을 삼킨 자",
            "검어진 물의 주인|물밑 종소리의 응답자|잠긴 수로의 문지기|버려진 주조장의 감시자|첫 번째 새벽종을 삼킨 자",
        ...
        group(
            ...
            "공문 사냥꾼|봉인을 먹는 자",
            "재 속 종이 새의 주인|지워진 수신인의 명령자|죽은 자의 전령|쫓기는 편지의 탈취자|오르반의 이름을 지키는 자",
            "봉인을 난도질한|죽은 명령을 따르는|종이 새를 좇는|지워진 이름을 먹은",
        ),
        group(
            "ash_border.c04",
            "예배당 박쥐|벽화 도마뱀|벽 틈 거미|지하 왕쥐|찬가 나방|청동 딱정벌레|계단 도롱뇽|문 없는 살쾡이|종벽 이끼골렘|침묵 포식새",
            "충돌하는 종소리|지하 찬가의 감시자",
            "문 없는 예배당을 지키는 자|종소리로 열린 길의 파수꾼|세 새벽종의 그림자|침묵의 찬가를 짓는 자|울리면 안 되는 종의 주인",
            "벽화 아래 웅크린|소리 없이 찬가하는|비밀 계단을 지키는|청동 먼지를 뒤집어쓴",
        ),
        group(
            "ash_border.c05",
        ...
        group(
            "ash_border.c06",
            "적진 들개|깃발 까마귀|천막 거미|재 흔적 하이에나|군패 도마뱀|빈 진지 여우|화살촉 딱정벌레|경계선 살쾡이|재무리 도롱뇽|진지 스크리커",
        ...
        group(
            "ash_border.c07",
            "성벽 들쥐|서문 박쥐|재 파도 도롱뇽|횃불 나방|종탑 거미|성벽 살쾡이|잿빛 스크리커|금 간 종 딱정벌레|서문 하이에나|재먹이 포식새",
        ...
        group(
            "ash_border.c08",
            "명령서 좀|인장 거미|기록실 박쥐|잉크 도롱뇽|철수 명령 까마귀|서기관 살쾡이|검은 재 딱정벌레|성채 왕쥐|밀랍 여우|조작 문서 나방",
            "서기관 사냥꾼|베른의 인장수",
        ...
        group(
            "ash_border.c09",
            "장례 수레 들쥐|검은 천 거미|쇠사슬 도마뱀|종 수레 까마귀|추격로 여우|밀수로 박쥐|청동 가루 딱정벌레|끊어진 다리 살쾡이|새벽종 상자 왕쥐|재 봉인 나방",
            "검은 종 호송자|새벽종 탈취자",
            "장례 행렬을 이끄는 자|천 아래 종의 감시자|끊어진 추격로의 파괴자|두 번째 새벽종을 훔친 자|한 번 울린 흔적의 주인",
            "검은 천을 뒤집어쓴|종 쇠사슬을 끌고 다니는|끊어진 추격로에 숨은|재로 봉인된",
        ),
        group(
            "ash_border.c10",
            "성채 왕쥐|빈 병영 거미|지하로 도마뱀|종소리 박쥐|재 갑옷 딱정벌레|성문 살쾡이|파수자 여우|잠든 자 나방|종홀 이끼골렘|재 왕의 사냥개",
            "베른의 친위수|잘못된 수호자",
            "닫히지 않는 문의 문지기|빈 병영의 모집관|베른의 고백을 지키는 자|잘못된 수호자의 그림자|마지막 새벽종을 지키는 자",
            "성채 안에서 기어나온|종소리에 홀린|재 갑옷을 두른|빈 병영을 배회하는",
        ),
        group(
            "ash_border.c11",
            "꺼진 하늘 박쥐|재 왕 들쥐|피난로 거미|종 울림 나방|잉걸 사자 까마귀|재 갑옷 왕쥐|성채문 도마뱀|잊힌 이름 살쾡이|새벽 포식자|재폭풍 스크리커",
            "재의 왕 친위대|새벽을 삼킨 투장",
        ...
        group(
            "ash_border.c12",
            "종소리 피라미|세 탑 까마귀|새벽 나방|유리 잎 들쥐|떨어진 재 도롱뇽|종탑 도마뱀|빛금 거미|국경 여우|유리 잎 딱정벌레|마지막 재 스크리커",
            "세 탑의 울림을 흐리는 자|돌아온 새벽의 포식자",
            "세 새벽종을 흩어 놓는 자|세 탑의 불빛을 끄는 자|함께 울린 종의 반향|돌아온 새벽의 마지막 재|유리 잎을 지키는 북방의 사자",
            "새벽빛에 흐려지는|유리 잎을 물은|세 종탑 사이를 오가는|마지막 재에서 피어난",
        ),
        group(
            "ash_border.epilogue_rebuild",
            "보급로 들쥐|수레바퀴 거미|표지석 도마뱀|다리 밑 여우|길목 나방|샛길 두꺼비|짐수레 까마귀|보급품 딱정벌레|진흙 하이에나|성문 살쾡이",
        ...
        group(
            ...
            "초소 들쥐|늦은 종 박쥐|군패 거미|귀환로 여우|폐허 도마뱀|순찰 명부 좀|표지석 까마귀|초소 왕쥐|종줄 살쾡이|오래된 임무 나방",
        ...
        group(
            ...
            "유리숲 들쥐|빛먹은 나방|북쪽 도롱뇽|투명 껍질 딱정벌레|이정표 까마귀|낯선 야영 여우|유리풀 거미|물길 살쾡이|빛 신호 박쥐|숲 가장자리 하이에나",
            "유리숲 경계자|세 불빛의 교란자",
            "빛을 머금은 잎의 포식자|북쪽 이정표를 지키는 자|유리숲 가장자리의 사냥꾼|낯선 야영지의 감시자|세 번의 답신을 흐리는 자",
            "유리 나무 사이의|북쪽 빛에 이끌린|낯선 불씨를 따라온|투명하게 굳은 껍질의",
        ),
        group(
            "ash_border.epilogue_waterway",
            "수문 슬라임|검은 띠 도롱뇽|종가루 거미|점검로 왕쥐|재 웅덩이 두꺼비|푸른 돌 딱정벌레|역류 물뱀|수로 살쾡이|녹슨 수문 거북|세 갈래 이끼골렘",
        ...
        group(
            ...
            "묘표 들쥐|명부 좀|유품 까마귀|공동묘지 거미|군패 여우|빗물 도롱뇽|편지 고리 딱정벌레|묘지 살쾡이|기억 등불 나방|북방 우편낭 왕쥐",
        ...
        group(
            ...
            "북방 들쥐|신호빛 나방|국경 너머 여우|낯선 장화 거미|골짜기 도롱뇽|거울탑 박쥐|사절길 살쾡이|북방 지도 까마귀|공동 표지석 딱정벌레|세 불빛 하이에나",
    ...
    ) + NorthernGlassMonsterCatalog.groups + PostgameMonsterCatalog.groups
